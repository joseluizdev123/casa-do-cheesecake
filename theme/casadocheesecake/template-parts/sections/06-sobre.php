...
<section class="sobre" id="sobre" data-figma-node="7057:349" aria-labelledby="sobre-titulo">
	<div class="sobre__inner container">
		<figure class="sobre__media" data-figma-node="7057:350">
			<img class="sobre__foto" src="<?php echo esc_url( cdc_image( 'cdc_sobre_imagem' ) ); ?>" width="1047" height="1400" loading="lazy" decoding="async" alt="<?php echo esc_attr( cdc_mod( 'cdc_sobre_imagem_alt' ) ); ?>">
