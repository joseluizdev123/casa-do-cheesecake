	...
	<div class="container">
		<div class="restaurantes__banner" data-figma-node="7057:509">
			...
			<div class="restaurantes__media" data-figma-node="7099:227">
				<img class="restaurantes__image" data-figma-node="7057:515" src="<?php echo esc_url( cdc_image( 'cdc_rest_imagem' ) ); ?>" width="357" height="305" alt="<?php echo esc_attr( cdc_mod( 'cdc_rest_imagem_alt' ) ); ?>" loading="lazy" decoding="async">
				<?php if ( cdc_rest_selo_visivel() ) : ?>
					<img class="restaurantes__selo" data-figma-node="7099:240" src="<?php echo esc_url( cdc_asset( 'images/09-restaurantes-selo.svg' ) ); ?>" width="53" height="63" alt="" loading="lazy" decoding="async">
				<?php endif; ?>
			</div>
