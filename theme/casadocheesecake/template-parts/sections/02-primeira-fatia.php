		...
		<div class="primeira-fatia__box" data-figma-node="7057:165">
			...
			<div class="primeira-fatia__media">
				<div class="primeira-fatia__images" data-figma-node="7057:172">
					<img class="primeira-fatia__img primeira-fatia__img--foreground" data-figma-node="7057:173" src="<?php echo esc_url( cdc_image( 'cdc_fatia_imagem_frente' ) ); ?>" width="206" height="191" alt="<?php echo esc_attr( cdc_mod( 'cdc_fatia_imagem_frente_alt' ) ); ?>">
					<img class="primeira-fatia__img primeira-fatia__img--background" data-figma-node="7057:174" src="<?php echo esc_url( cdc_image( 'cdc_fatia_imagem_fundo' ) ); ?>" width="305" height="305" alt="<?php echo esc_attr( cdc_mod( 'cdc_fatia_imagem_fundo_alt' ) ); ?>">
				</div>
			</div>
			...
			<div class="primeira-fatia__content" data-figma-node="7057:167">
				...
				<p class="primeira-fatia__text" data-figma-node="7057:169"><?php echo cdc_rich( cdc_mod( 'cdc_fatia_texto' ) ); // phpcs:ignore WordPress.Security.EscapeOutput -- escapado em cdc_rich(). ?></p>
